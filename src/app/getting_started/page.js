...
export async function generateMetadata() {
  return {
    title: "Create Account | SupportSPOC Ticketing, Live Chat & AI Chatbot",
    description:
      "Create your SupportSPOC account and get started with Ticketing, Live Chat, and AI Chatbot for customer support.",
    keywords: [
      "account creation",
      "signup",
      "ticketing system",
    ...
    openGraph: {
      title: "Create Account | SupportSPOC Ticketing, Live Chat & AI Chatbot",
      description:
        "Sign up for SupportSPOC and streamline customer queries with our Ticketing System, Live Chat, and AI Chatbot.",
      type: "website",
      url: "https://www.supportspoc.com/create-account",
      images: [
        {
          url: "https://www.supportspoc.com/images/signup-preview.png",
          width: 1200,
          height: 630,
          alt: "SupportSPOC Signup Preview",
        },
      ],
    },
    twitter: {
      ...
      title: "Create Account | SupportSPOC Ticketing, Live Chat & AI Chatbot",
      description:
        "Open a SupportSPOC account today and start managing tickets, chats, and calls with AI-powered support tools.",
      images: ["https://www.supportspoc.com/images/signup-preview.png"],
    },
  };
}
